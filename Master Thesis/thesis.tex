...
\vspace{-15pt}  
  \begin{center}
  \hspace{-2cm}
    \includegraphics[scale=0.35]{Systemdesc.png}
  \end{center}
...
Both rebuilding and reorganizing are built-in operations in SQL-Server 2014. These are two different operations that both reduce the fragmentation of the indexes. Reorganizing is the more lightweight of the two operations.
