...
\section{Limitations}
The objective is primarily to increase the speed of the ERP-system's BI reporting module by optimizing the database. The database is used by all parts of \bex Online. This means that the 

The time frame of a master thesis is limited and therefore work limitations have to exist. The system consists of several essential parts, all of which can be optimized in different extent. The focus of this thesis's is speed optimization of BI reports and therefore the following limitations have been established:
\begin{itemize}
