...
\item Research will be performed to learn of approaches to solve the problems identified in the analysis. The research will consider as many options as possible to find a long-term solution.
...
The research questions of this thesis relate to the thesis goals in section \ref{sec:goals}
\section{Methodology}
