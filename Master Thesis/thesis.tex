...
The goal of this thesis is to examine, test the feasibility and implement a solution for speeding up the generation of business intelligence reports in Perfect IT BeX\textsuperscript{\textregistered} AB's product BeX\textsuperscript{\textregistered} Online. 
\section{Scope}
...
\section{Limitations}
The objective is primarily to increase the speed of the ERP-system's business intelligence reporting module by optimizing the database. The database is used by all parts of BeX\textsuperscript{\textregistered} Online. This means that the solution must not affect any functionality in \bex Online.
