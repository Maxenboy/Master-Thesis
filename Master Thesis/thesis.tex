...
\section{Background}
Perfect It BeX AB has three products; \bex Online, \bex Retail, and \bex B2B. \bex Online is the main product on which the other products rely. 

\subsection{BI-report generation}
...
\begin{wrapfigure}{r}{0.5\textwidth} 
  \vspace{-20pt}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{Optimization-process.png}
  \end{center}
  \vspace{-20pt}
